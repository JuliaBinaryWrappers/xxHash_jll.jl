...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import xxHash_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("5fdcd639-92d1-5a06-bf6b-28f2061df1a9"))
platforms = [Pkg.Artifacts.unpack_platform(e, "xxHash", artifacts_toml) for e in artifacts["xxHash"]]
...
if best_platform === nothing
    @debug("Unable to load xxHash; unsupported platform $(triplet(platform_key_abi()))")
else
